...
#ifndef AEIOU_HEADER_CONFIGURATIONS_PLATFORMS_LINUX_HH
#define AEIOU_HEADER_CONFIGURATIONS_PLATFORMS_LINUX_HH
...
#define AEIOU_CONFIG_PLATFORM AEIOU_CONFIG_LINUX
